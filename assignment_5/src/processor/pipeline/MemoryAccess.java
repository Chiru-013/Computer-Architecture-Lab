	...
	public void performMA() {
		...
		if(EX_MA_Latch.isMA_enable() && EX_MA_Latch.is_busy == false) {
			if(EX_MA_Latch.is_nop == true) {
				...
				MA_RW_Latch.inst_PC = EX_MA_Latch.inst_PC;
				//System.out.println("MA\t" + EX_MA_Latch.inst_PC + "\trs1:" + rs1 + "\trs2:" + rs2 + "\trd:" + rd + "\timm:" + imm + "\talu:" + aluResult);
				...
				// if(Simulator.storeresp + Configuration.mainMemoryLatency >= Clock.getCurrentTime()) EX_MA_Latch.is_busy = false;
