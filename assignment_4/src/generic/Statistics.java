...
public class Statistics {
	...
	public static void printStatistics(String statFile)
	{
		try
		{
			...
			writer.println("Number of wrong branches taken = " + numberOfBranchTaken);
			writer.println("Number of OF Stalls: " + (Statistics.getNumberOfInstructions() - Statistics.getNumberOfRegisterWriteInstructions()));
